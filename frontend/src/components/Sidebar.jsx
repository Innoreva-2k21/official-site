...
const Sidebar = () => {
  return (
      <div className=" h-screen w-fit p-1 ">
        <div className=" flex flex-col h-full justify-evenly  font-[Archivo] text-8xl font-extrabold [-webkit-text-stroke:2px_#ffffffff] text-transparent m-1">
